...
abstract class InterestsDao{
  ...
  @Query("SELECT * FROM InterestsModel WHERE type = 'traveling'")
  Future<List<InterestsModel>> getTravelingInterests();
  ...
  @Query("SELECT * FROM InterestsModel WHERE type = 'general'")
  Future<List<InterestsModel>> getGeneralInterests();
  ...
  @Query("SELECT * FROM InterestsModel WHERE type = 'career'")
  Future<List<InterestsModel>> getCareerInterests();
