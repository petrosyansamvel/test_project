...
class _$InterestsDao extends InterestsDao {
  ...
  @override
  Future<List<InterestsModel>> getGeneralInterests() async {
    return _queryAdapter.queryList(
      'SELECT * FROM InterestsModel WHERE type = \'general\'',
      mapper: (Map<String, Object?> row) => InterestsModel(
          row['id'] as int?,
          row['name'] as String?,
          row['type'] as String?,
  ...
  @override
  Future<List<InterestsModel>> getCareerInterests() async {
    return _queryAdapter.queryList(
        'SELECT * FROM InterestsModel WHERE type = \'career\'',
        mapper: (Map<String, Object?> row) => InterestsModel(
            row['id'] as int?,
            row['name'] as String?,
            row['type'] as String?,
  ...
  @override
  Future<List<InterestsModel>> getTravelingInterests() async {
    return _queryAdapter.queryList(
        'SELECT * FROM InterestsModel WHERE type = \'traveling\'',
        mapper: (Map<String, Object?> row) => InterestsModel(
            row['id'] as int?,
            row['name'] as String?,
            row['type'] as String?,
